...
if [[ $STATUS == "'prefer-light'" ]]; then
	...
	cp ~/Rice/Current/Configs/hyprland/theme-dark.conf ~/.config/hypr/theme.conf
	cp ~/Rice/Current/Configs/ncmpcpp/config-dark  ~/.config/ncmpcpp/config
	pkill ncmpcpp
...
if [[ $STATUS == "'prefer-dark'" ]]; then
	...
	cp ~/Rice/Current/Configs/hyprland/theme-light.conf ~/.config/hypr/theme.conf
	cp ~/Rice/Current/Configs/ncmpcpp/config-light  ~/.config/ncmpcpp/config
	pkill ncmpcpp
